            ...
            <Navbar.Collapse id="responsive-navbar-nav">
             <Nav className="ms-3 mt-3">
                  ...
                  <div className='d-lg-none d-block'>
                    ...
                    <FontAwesomeIcon icon={faHome}/><span className='px-2'>Instant</span>
                    </Link>
                    <br />
                    <Link className='text-decoration-none text-white' to='/'>
                    <FontAwesomeIcon icon={faSignal}/><span className='px-2'>Schcdule</span>
                    </Link>
                    <br />
                    <Link className='text-decoration-none text-white' to='/'>
                    <FontAwesomeIcon icon={faSignal}/><span className='px-2'>Usage</span>
                    </Link>                   
                  </div>
             </Nav>
      ...
      <div className='row'>
        <div className='col-2  d-lg-block d-none '>
            ...
            <div className='ms-3'>
             ...
             <FontAwesomeIcon className='text-dark' icon={faHome}/><span className='px-2'>Instant</span>
             </Link>
             <br />
             <Link to='/' className='text-decoration-none fw-bold'>
             <FontAwesomeIcon className='text-dark' icon={faSignal}/><span className='px-2'>Schcdule</span> 
             </Link>
             <br />
             <Link to='/' className='text-decoration-none fw-bold'>
             <FontAwesomeIcon className='text-dark' icon={faSignal}/><span className='px-2'>Usage</span> 
             </Link>           
            </div>
